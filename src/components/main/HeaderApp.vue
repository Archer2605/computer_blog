            ...
            <nav  class="navbar navbar-expand-lg navbar-light bg-light position-fixed fixed-top px-5" style="box-shadow: 0 0 10px rgba(0,0,0,0.2);">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        ...
                        <span @click="handlerClickSearch()" style="cursor: pointer;" class="ml-2"><i class="fa-solid fa-magnifying-glass"></i></span>
                    </div>
...
export default{
    ...
    methods:{
        ...
        ...mapActions(['getListCategory','getListBlog','getListBlogBySearch']),
        handlerClickSearch(){
            const searchKey = this.searchKey
            this.getListBlogBySearch(searchKey)
            this.$router.push({name:"home"})
        }
    },
    created(){
        ...
        if(token){
            axios.post('http://localhost:3000/api/verify',{token:token})
            .then(response=>{
